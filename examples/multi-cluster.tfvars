# Multi-cluster configuration example: EKS v1.30 vs v1.32 comparison
# Usage: terraform apply -var-file=examples/multi-cluster.tfvars
...
clusters = {
  ...
  "1-32" = {
    ...
    driver_nodepool = {
      cpu_limit           = "128"
      instance_categories = ["m", "c"]
      instance_sizes      = ["2xlarge", "4xlarge", "8xlarge", "12xlarge"]
